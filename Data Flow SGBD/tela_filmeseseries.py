...
def abrir_tela_auditoria(master, db, frame_midias, usuario_logado):
    from Auditoria import TelaAuditoria
    ts = TelaAuditoria(master, db, frame_midias, usuario_logado)
    ts.iniciar()
...
class FilmeseSeries:
    ...
    def setup_tela_midias(self):
        ...
        # Nome
        make_label(frame_esquerdo, "Nome:", 0)
        ...
        # Diretores
        make_label(frame_esquerdo, "Diretores:", 2)
        entry_diretores = make_entry(frame_esquerdo, 3)
        ...
        # Ano de estreia
        make_label(frame_esquerdo, "Ano de estreia:", 4)
        entry_ano = make_entry(frame_esquerdo, 5)
        ...
        # Plataforma
        make_label(frame_esquerdo, "Plataforma:", 6)
        entry_plataforma = make_entry(frame_esquerdo, 7)
        ...
        # Duração
        make_label(frame_esquerdo, "Duração:", 8)
        entry_duracao = make_entry(frame_esquerdo, 9)
        ...
        # Temporadas
        make_label(frame_esquerdo, "Temporadas:", 10)
        entry_temporadas = make_entry(frame_esquerdo, 11)
        ...
        # Episódios
        make_label(frame_esquerdo, "Episódios:", 12)
        entry_episodios = make_entry(frame_esquerdo, 13)
        ...
        self.tree = ttk.Treeview(
            frame_tabela,
            columns=("ID", "Nome", "Diretores", "Ano", "Plataforma", "Duração", "Temporadas", "Episódios"),
            show="headings",
    ...
    def ir_para_auditoria(self):
        self.frame_midias.pack_forget()
        abrir_tela_auditoria(self.master, self.db, self.frame_midias, self.usuario_logado)
    ...
    def salvar_midia(self):
        tipo = self.combo_tipo.get().strip()  # Adicione campo para tipo se necessário
    ...
    def carregar_para_edicao(self):
        ...
        for campo, valor in zip(list(self.placeholders.keys()), midia[1:]):
